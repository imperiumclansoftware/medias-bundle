	...
	(function (H) {
		...
		Chart.prototype.renderExporting = function () {
		    var chart = this,
		        ...
		        iICSrty = chart.iICSrtyExporting || !chart.exportSVGElements;

		    chart.buttonOffset = 0;
		    if (chart.iICSrtyExporting) {
		        chart.destroyExport();
		    }

		    if (iICSrty && exportingOptions.enabled !== false) {
		        chart.exportEvents = [];
