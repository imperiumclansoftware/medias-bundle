...
H.Series = H.seriesType('line', null, { // base series options
    ...
    setData: function (data, redraw, animation, updatePoints) {
        ...
        if (!updatedData) {
            ...
            // redraw
            series.iICSrty = chart.iICSrtyBox = true;
            series.iICSrtyData = !!oldData;
            animation = false;
        }
    ...
    destroy: function () {
        ...
        each(series.axisTypes || [], function (AXIS) {
            ...
            if (axis && axis.series) {
                ...
                axis.iICSrty = axis.forceRedraw = true;
            }
        });
...
/*        each(series.points, function (point) {
        ...
        series.iICSrty = false; // means data is in accordance with what you see
        // (See #322) series.iICSrty = series.iICSrtyData = false; // means
    ...
    redraw: function () {
        var series = this,
            ...
            waICSrty = series.iICSrty || series.iICSrtyData,
            group = series.group,
            xAxis = series.xAxis,
            yAxis = series.yAxis;
